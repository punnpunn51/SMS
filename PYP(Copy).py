...
88""Yb Yb  dP 88""Yb     88  88 88   88 88""Yb 
88__dP  YbdP  88__dP     88  88 88   88 88__dP 
88"""    8P   88"""      888888 Y8   8P 88""Yb 
88      dP    88         88  88 `YbodP' 88oodP 
 ...
 |_|_|_\__,_\__,_\___| |_.__/\_, | 
                             |__/  
      ___           __         _   _ _   _ ___ ___ ____ 
  / __|___ __ _ / _|__ _ __| |_| | |_/ |_  | _ )__  |
 | (_ (_-</ _` |  _/ _` / _` |_  .  _| |/ // _ \ / / 
  \___/__/\__,_|_| \__,_\__,_|_     _|_/___\___//_/  
                               |_|_|                 
	...
	phone = input(" \x1b[90m[+] Enter Phone : \x1b[94m")
	if int(phone) <= 99999999 or int(phone) >= 999999999:
		...
		jam = int(input(" \x1b[90m[+] Enter Count : \x1b[91m"))
		print()
		print()
		...
		def api1():
			...
			print(f'\x1b[90m[+] ATTACK TO {phone}!\x1b[94m')
		def api2():
